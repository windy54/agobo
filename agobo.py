...
#modified by SAG because the seem the wrong way round
#irledtest program changes right line output when left ir led changes state
...
#======================================================================
# IR Sensor Functions
# False equates to black and True to white detected
#
# irLeftLine(): Returns state of Left IR Line sensor
def irLeftLine():
